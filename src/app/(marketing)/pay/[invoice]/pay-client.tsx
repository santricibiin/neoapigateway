    ...
    <div className="relative flex min-h-screen flex-col gap-6 overflow-x-hidden py-6 sm:gap-8 sm:py-8">
      ...
      <div className="relative grid gap-6 lg:grid-cols-[1fr_380px] lg:gap-8">
        ...
        <div className="flex flex-col gap-5">
          <AnimatePresence mode="wait">
            {isPending && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -12 }}
                className="flex flex-col items-center gap-5 rounded-neo border border-base-line bg-base-surface p-6 shadow-neo sm:p-8"
              >
                ...
                <div className="flex items-center gap-2 rounded-neo border border-base-line bg-base-bg px-4 py-2 shadow-neo-sm">
            ...
            {isPaid && (
              ...
              >
                {/* Hero sukses */}
                <div className="relative overflow-hidden rounded-neo border border-base-line bg-accent-mint p-8 text-center shadow-neo">
                  <motion.svg
                    animate={{ rotate: 360 }}
                ...
                {order.delivered ? (
                  ...
                  <div className="flex items-center gap-3 rounded-neo border border-base-line bg-base-bg p-4 shadow-neo-sm">
            ...
            {isExpired && (
              <motion.div
                ...
                className="flex flex-col items-center gap-3 rounded-neo border border-base-line bg-accent-sun p-8 text-center shadow-neo"
              >
          ...
          <div className="rounded-neo border border-base-line bg-base-surface p-5 shadow-neo sm:p-6">
            ...
            <ol className="mt-3 grid gap-3 sm:grid-cols-3">
              <li className="flex gap-3 rounded-neo border border-base-line/10 bg-base-bg p-3">
        ...
        <aside className="flex flex-col gap-5">
          ...
          <div className="flex items-start gap-3 rounded-neo border border-base-line bg-accent-sunSoft p-4">
