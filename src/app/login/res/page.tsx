...
import { Users, ArrowLeft, Eye, EyeOff, Loader2 } from "lucide-react";
      ...
      >
        <div className="rounded-neo border-2 border-base-ink bg-base-surface shadow-neo-lg">
          <div className="flex flex-col items-center gap-3 border-b-2 border-base-ink bg-accent-sky p-6">
            ...
            <h1 className="text-2xl font-extrabold tracking-tight">Reseller Web</h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5 p-6">
            ...
            >
              <label htmlFor="password" className="text-sm font-semibold text-base-ink">
                Password
              </label>
