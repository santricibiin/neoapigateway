  ...
  return (
    <div className="mx-auto w-full max-w-6xl">
      <div className="mb-5 sm:mb-7">
        <span className="mb-2 inline-flex items-center gap-2 rounded-full border-2 border-base-ink bg-accent-sky px-3 py-1 text-xs font-black uppercase tracking-wider">
          ...
          <section className="overflow-hidden rounded-neo border-2 border-base-ink bg-base-surface shadow-neo-sm">
            ...
            <div className="grid gap-4 p-4 sm:p-5 md:grid-cols-2">
              <div className="flex flex-col gap-1.5">
                ...
                <textarea name="welcomeText" defaultValue={initial.welcomeText} rows={5} className="w-full resize-y rounded-neo border-2 border-base-ink bg-base-surface px-4 py-3 text-xs leading-relaxed shadow-neo-sm outline-none focus:shadow-neo" />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-semibold">Kategori {`{kategori}`}</label>
                <textarea name="categoryText" defaultValue={initial.categoryText} rows={5} className="w-full resize-y rounded-neo border-2 border-base-ink bg-base-surface px-4 py-3 text-xs leading-relaxed shadow-neo-sm outline-none focus:shadow-neo" />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-semibold">List Produk {`{produk}`}</label>
                <textarea name="productListText" defaultValue={initial.productListText} rows={5} className="w-full resize-y rounded-neo border-2 border-base-ink bg-base-surface px-4 py-3 text-xs leading-relaxed shadow-neo-sm outline-none focus:shadow-neo" />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-semibold">Detail Produk</label>
                <textarea name="productDetailText" defaultValue={initial.productDetailText} rows={5} className="w-full resize-y rounded-neo border-2 border-base-ink bg-base-surface px-4 py-3 text-xs leading-relaxed shadow-neo-sm outline-none focus:shadow-neo" />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-semibold">Invoice QRIS {`{invoice}`}</label>
                <textarea name="qrisInvoiceText" defaultValue={initial.qrisInvoiceText} rows={5} className="w-full resize-y rounded-neo border-2 border-base-ink bg-base-surface px-4 py-3 text-xs leading-relaxed shadow-neo-sm outline-none focus:shadow-neo" />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-semibold">Pembayaran Sukses {`{produk_items}`}</label>
                <textarea name="paymentSuccessText" defaultValue={initial.paymentSuccessText} rows={5} className="w-full resize-y rounded-neo border-2 border-base-ink bg-base-surface px-4 py-3 text-xs leading-relaxed shadow-neo-sm outline-none focus:shadow-neo" />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-semibold">Terima Kasih</label>
                <textarea name="thankYouText" defaultValue={initial.thankYouText} rows={5} className="w-full resize-y rounded-neo border-2 border-base-ink bg-base-surface px-4 py-3 text-xs leading-relaxed shadow-neo-sm outline-none focus:shadow-neo" />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-semibold">QRIS Kedaluwarsa</label>
                <textarea name="qrisExpiredText" defaultValue={initial.qrisExpiredText} rows={5} className="w-full resize-y rounded-neo border-2 border-base-ink bg-base-surface px-4 py-3 text-xs leading-relaxed shadow-neo-sm outline-none focus:shadow-neo" />
              </div>
            </div>
          </section>
        </div>
        ...
        <div className="space-y-4 sm:space-y-6 lg:sticky lg:top-24">
          <section className="overflow-hidden rounded-neo border-2 border-base-ink bg-base-surface shadow-neo">
            ...
            <div className="space-y-2 p-4 sm:p-5 text-sm">
              ...
              <pre className="rounded-neo border-2 border-base-ink bg-base-bg px-3 py-2 font-mono text-xs">npm run bot:poll</pre>
